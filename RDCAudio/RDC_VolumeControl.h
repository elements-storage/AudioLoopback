...
#ifndef RDCDriver__RDC_VolumeControl
#define RDCDriver__RDC_VolumeControl
...
public:
                        RDC_VolumeControl(AudioObjectID inObjectID,
...
#endif /* RDCDriver__RDC_VolumeControl */

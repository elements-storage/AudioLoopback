...
//
//  If we change RDCDevice's controls list, to match the output device set in RDCApp, we need to
...
//  for a short period.
//
//  Instead, RDCApp temporarily enables this device and uses it to toggle the default device. This
...
#ifndef RDCDriver__RDC_NullDevice
#define RDCDriver__RDC_NullDevice
...
public:
    static RDC_NullDevice&      GetInstance();
...
public:
    CFStringRef                 CopyDeviceUID() const
                                    { return CFSTR(kRDCNullDeviceUID); };
...
private:
    ...
    static RDC_NullDevice*      sInstance;
...
#endif /* RDCDriver__RDC_NullDevice */

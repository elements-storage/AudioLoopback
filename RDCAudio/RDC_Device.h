...
#ifndef RDCDriver__RDC_Device
#define RDCDriver__RDC_Device

// SuperClass Includes
#include "RDC_AbstractDevice.h"

// Local Includes
#include "RDC_Types.h"
#include "RDC_WrappedAudioEngine.h"
...
class RDC_Device
:
	public RDC_AbstractDevice
{

#pragma mark Construction/Destruction
    
public:
    static RDC_Device&			GetInstance();
    
private:
    static void					StaticInitializer();

protected:
                                RDC_Device(AudioObjectID inObjectID,
...
public:
	/*!
	 ...
	 See RDC_Device::PerformConfigChange and RequestDeviceConfigurationChange in AudioServerPlugIn.h.
	 */
...
private:
     ...
     */
	const RDC_Object&		    GetOwnedObjectByID(AudioObjectID inObjectID) const;
	RDC_Object&                 GetOwnedObjectByID(AudioObjectID inObjectID);
    ...
    /*!
     ...
     for the device. See RDC_Device::RequestEnabledControls, RDC_Device::PerformConfigChange and
...
public:
    ...
    /*! Cancel a change requested with RDC_PlugIn::Host_RequestDeviceConfigurationChange. */
	void						AbortConfigChange(UInt64 inChangeAction, void* __nullable inChangeInfo);

    void                        ApplyVolume(UInt32 inClientID, UInt32 inIOBufferFrameSize, void* __nonnull inBuffer) const;
...
private:
    ...
    RDC_WrappedAudioEngine* __nullable mWrappedAudioEngine;
    
    RDC_TaskQueue               mTaskQueue;
    
    RDC_Clients                 mClients;
    ...
    RDC_Stream                  mInputStream;
    RDC_Stream                  mOutputStream;
    ...
    RDC_VolumeControl			mVolumeControl;
	RDC_MuteControl				mMuteControl;
    bool                        mPendingOutputVolumeControlEnabled = true;
    bool                        mPendingOutputMuteControlEnabled   = true;

};

#endif /* RDCDriver__RDC_Device */

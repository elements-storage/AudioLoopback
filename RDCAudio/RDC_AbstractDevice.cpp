...
RDC_AbstractDevice::RDC_AbstractDevice(AudioObjectID inObjectID, AudioObjectID inOwnerObjectID)
:
    RDC_Object(inObjectID, kAudioDeviceClassID, kAudioObjectClassID, inOwnerObjectID)
{
}

RDC_AbstractDevice::~RDC_AbstractDevice()
{
}

#pragma mark Property Operations

bool    RDC_AbstractDevice::HasProperty(AudioObjectID inObjectID,
                                        pid_t inClientPID,
...
bool    RDC_AbstractDevice::IsPropertySettable(AudioObjectID inObjectID,
                                               pid_t inClientPID,
                                               const AudioObjectPropertyAddress& inAddress) const
{
    bool theAnswer = false;
...
UInt32    RDC_AbstractDevice::GetPropertyDataSize(AudioObjectID inObjectID,
                                                  pid_t inClientPID,
...
void    RDC_AbstractDevice::GetPropertyData(AudioObjectID inObjectID,
                                            pid_t inClientPID,
                                            const AudioObjectPropertyAddress& inAddress,
                                            UInt32 inQualifierDataSize,
                                            ...
                                            void* outData) const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        case kAudioDevicePropertyAvailableNominalSampleRates:
            ...
            // a required property that can't be handled by this class or its parent, RDC_Object.
            //
            // See RDC_Device for info about these properties.
            //
            // TODO: Write a test that checks all required properties for each subclass.
            RDCAssert(false,
                      "RDC_AbstractDevice::GetPropertyData: Property %u not handled in subclass",
                      inAddress.mSelector);
        ...
        case kAudioDevicePropertyTransportType:
            ...
            ThrowIf(inDataSize < sizeof(UInt32),
                    ...
                    "RDC_AbstractDevice::GetPropertyData: not enough space for the return value of "

...
#ifndef RDCDriver__RDC_MuteControl
#define RDCDriver__RDC_MuteControl
...
public:
                              RDC_MuteControl(AudioObjectID inObjectID,
...
#endif /* RDCDriver__RDC_MuteControl */
